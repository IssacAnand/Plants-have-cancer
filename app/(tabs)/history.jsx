    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            await clearAllScans();
            await loadRecentScans(); // refresh state
          },
        },
      ]
    );
  ...
  return (
    <SafeAreaView className="flex-1 bg-surface">
      ...
      {/*
        ...
        It only renders items currently visible on screen (virtualisation).
        For short lists (≤20 items) ScrollView + .map() also works fine,
        but FlatList is the recommended pattern.
      */}
      <FlatList
        data={recentScans}
